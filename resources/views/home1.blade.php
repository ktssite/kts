...
<body>
    ...
    <header id="home">
        <!-- Background Image -->
        <div class="bg-img" style="background-image: url('/images/background1.jpg');">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <div class="home-content">
                            <h1 class="white-text">Kraite Trading School</h1>
                            <p class="white-text">Trading is just a game and money is just paper.
                            </p>
                            <a class="white-btn" href="/login">Login</a>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="contact">
                        ...
                        <h3>Email</h3>
                        <p>kraite.hernandex@gmail.com</p>
                    </div>
                </div>
                <!-- /contact -->
                ...
                <div class="col-sm-4">
                    <div class="contact">
                        ...
                        <h3>Address</h3>
                        <p>Door #3 Apartment #007  <br>
                            Alitaptap St. Lanzona Subdivision <br>
